class Menu extends Phaser.Scene {
    constructor() {
        super("menuScene") // Basically gives names the key to this objct menuScene
    }
    ...
    preload() {
        ...
        this.load.spritesheet('explosion', './assets/explosion.png', { // Has to be different since there's multiple sprites in this image
            frameWidth: 64,
            frameHeight: 32,
            startFrame: 0,
            endFrame: 9
